...
document.getElementById('gramsInput').addEventListener('input', function(e){
	...
	document.getElementById('lbsOutput').innerHTML = grams/453.592;
	document.getElementById('kgOutput1').innerHTML = grams/1000;
	document.getElementById('ozOutput1').innerHTML = grams*28.3498140252;
});